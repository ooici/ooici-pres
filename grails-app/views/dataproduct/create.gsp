...
<div class="container_16">
	...
	<div class="clear"></div>
	<div class="grid_16">
		<h2 id="page-heading">LCA Demo - Register a Data Product</h2>
	</div>
	<div class="clear"></div>
	<div class="grid_4">
		<div class="box menu">
			...
			<div class="block">
				<ul class="section menu">
					...
					<li>Data Products
						<ul class="submenu">
							<li><g:link controller="dataproduct" action="show">View all Data Products</g:link></li>
							<li><g:link controller="dataproduct" action="create" class="active">Register a Data Product</g:link></li>
						</ul>
					</li>
				</ul>
			</div>
	...
	<div class="grid_7">
		<div class="box">
			...
			<div class="block" id="blockquote">
				<blockquote>
					<p>To Register a new Data Product, in the form below, please enter the Name, select the Instrument and Data Format.  Select the Register button when done.</p>
					<p class="cite"><cite>OOICI Support</cite></p>
				</blockquote>
			</div>
		</div>
		<div class="box">
			<h2><a href="#" id="toggle-forms">Register a new Data Product</a></h2>
			<div class="block" id="forms">
				<g:form action="save" method="post">
					<fieldset>
						...
						<g:hasErrors bean="${dpInstance}">
							<div class="errors">
								<g:renderErrors bean="${dpInstance}" as="list"/>
							</div>
						</g:hasErrors>
						<legend>New Data Product</legend>
						<p>
