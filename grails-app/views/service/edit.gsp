                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="status"><g:message code="service.status.label" default="Status" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: serviceInstance, field: 'status', 'errors')}">
                                    <g:textField name="status" value="${serviceInstance?.status}" />
                                </td>
                            </tr>
