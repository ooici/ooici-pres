	...
	<div class="grid_7">
		<div class="box">
			...
			<div class="block" id="blockquote">
				<blockquote>
					<p>To get/set an instrument parameter, in the form below, please enter the parameter name/value, and press the get/set button when done.</p>
					<p class="cite"><cite>OOICI Support</cite></p>
				</blockquote>
			</div>
		</div>
		<div class="box">
			<h2><a href="#" id="toggle-forms">Get/Set Instrument parameter</a></h2>
			<div class="block" id="forms">
				<g:form action="getset" method="post">
					<fieldset>
						...
						<p>
							<label><g:message default="Parmeter Name" />Parameter Name</label>
							<g:textField name="ParameterName" value="" />
						</p>
						<p>
							<label><g:message default="Parameter Value" />Value</label>
							<g:textField name="ParameterValue" value="" />
						</p>
						<g:submitButton name="Get" class="save" value="Get Parameter"/>
						<g:submitButton name="Set" class="save" value="Set Parameter"/>
